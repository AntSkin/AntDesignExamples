...
namespace Overview.Controls
{
    partial class Select
    {
        ...
        private void InitializeComponent()
        {
            ...
            // select8
            //
            select8.Items.AddRange(new AntDesign.ISelectItem[] { new AntDesign.SelectItem(0, "Lucy"), new AntDesign.SelectItem(1, "Tom"), new AntDesign.SelectItem(1, "AduSkin"), new AntDesign.DividerSelectItem(), new AntDesign.SelectItem(0, "WangLi"), new AntDesign.SelectItem(0, "HUAWEI"), new AntDesign.SelectItem(0, "XIAOMI") });
            select8.DropDownArrow = true;
            select8.Placement = AntDesign.TAlignFrom.TR;
            select8.List = true;
