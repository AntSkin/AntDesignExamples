...
namespace Overview.Controls
{
    partial class InputNumber
    {
        ...
        {
            input1 = new AntDesign.InputNumber();
            input2 = new AntDesign.InputNumber();
            input3 = new AntDesign.InputNumber();
            input4 = new AntDesign.InputNumber();
            input5 = new AntDesign.InputNumber();
            input6 = new AntDesign.InputNumber();
        ...
        private AntDesign.InputNumber input1;
        private AntDesign.InputNumber input2;
        private AntDesign.InputNumber input3;
        private AntDesign.InputNumber input4;
        private AntDesign.InputNumber input5;
        private AntDesign.InputNumber input6;
